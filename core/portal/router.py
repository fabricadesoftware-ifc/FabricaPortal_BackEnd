...
from core.portal.views import AccessViewSet, AreaViewSet, CourseMemberViewSet, CourseViewSet, MemberTagViewSet, MemberViewSet, ProjectViewSet, NewViewSet, TagViewSet
...
portal_router.register(r'member_tags', MemberTagViewSet)
